...
void DNN::run_nn(q7_t* in_data, q7_t* out_data)
{
	...
	// IP1 
	xtensa_fully_connected_q7(in_data, ip1_wt, IN_DIM, IP1_OUT_DIM, 1, 7, ip1_bias, ip1_out, vec_buffer);
        // RELU1
	xtensa_relu_q7(ip1_out, IP1_OUT_DIM);

	// IP2 
	xtensa_fully_connected_q7(ip1_out, ip2_wt, IP1_OUT_DIM, IP2_OUT_DIM, 2, 8, ip2_bias, ip2_out, vec_buffer);
        // RELU2
	xtensa_relu_q7(ip2_out, IP2_OUT_DIM);

	// IP3 
	xtensa_fully_connected_q7(ip2_out, ip3_wt, IP2_OUT_DIM, IP3_OUT_DIM, 2, 9, ip3_bias, ip3_out, vec_buffer);
        // RELU3
	xtensa_relu_q7(ip3_out, IP3_OUT_DIM);

	// IP4 
	xtensa_fully_connected_q7(ip3_out, ip4_wt, IP3_OUT_DIM, OUT_DIM, 0, 6, ip4_bias, out_data, vec_buffer);
