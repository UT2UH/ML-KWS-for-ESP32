 ...
 * Title:        xtensa_nn_accumulate_q7_to_q15.c
...
void xtensa_nn_accumulate_q7_to_q15(q15_t *pDst, const q7_t *pSrc, uint32_t length)
{
    q15_t *pCnt = pDst;
    const q7_t *pV = pSrc;
    q31_t v1, v2, vo1, vo2;
    ...
    while (cnt > 0l)
    {
        q31_t value = xtensa_nn_read_q7x4_ia(&pV);
        v1 = __SXTB16(__ROR(value, 8));
        v2 = __SXTB16(value);
#ifndef XTENSA_MATH_BIG_ENDIAN
