 ...
 * Title:        xtensa_fully_connected_q7_opt.c
 ...
 */
   ...
   *  xtensa_q7_to_q15_no_shift_shuffle function to expand into
...
xtensa_status
xtensa_fully_connected_q7_opt(const q7_t * pV,
                           const q7_t * pM,
                           ...
                           q15_t * vec_buffer)
{
    ...
    /* Return to XTENSA_MATHATH_SUCCESS */
