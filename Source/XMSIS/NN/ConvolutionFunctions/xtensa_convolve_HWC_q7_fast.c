 ...
 * Title:        xtensa_convolve_HWC_q7_fast.c
 ...
 */
   ...
   * xtensa_q7_to_q15_reordered_no_shift. For every four elements, the second and
   * third elements are swapped.
   *
   * The computation kernel xtensa_nn_mat_mult_kernel_q7_q15_reordered does the
...
xtensa_status
xtensa_convolve_HWC_q7_fast(const q7_t * Im_in,
                         ...
                         q7_t * bufferB)
{
    ...
    if (ch_im_in % 4 != 0 || ch_im_out % 2 != 0)
    {
        ...
        return XTENSA_MATH_SIZE_MISMATCH;
    }
