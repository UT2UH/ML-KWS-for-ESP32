...
/**
   ...
   * - XTENSA_MATHATH_DSP:
   *
   * Define macro XTENSA_MATHATH_DSP, If the silicon supports DSP instructions.
   *
...
#ifndef _XTENSA_NNFUNCTIONS_H
#define _XTENSA_NNFUNCTIONS_H

#include "xtensa_nnsupportfunctions.h"
#include "xtensa_nn_tables.h"
 ...
 * computed with GEMM kernels similar to CMSIS-DSP xtensa_mat_mult functions.
 *
 */
...
/**
   ...
   *                              when both XTENSA_MATHATH_LOOPUNROLL aXTENSA_MATHA_MATH_DSP are defined.
   *                              Required space: (2 * input_ch * kernel_x * kernel_y) * sizeof(q15_t) bytes
   *                              Use xtensa_convolve_s8_get_buffer_size() to get the size.
   * @return     The function returns <code>XTENSA_MATHATH_SUCCESS</code>
   *
   * @details
   ...
   *
   */
    xtensa_status xtensa_convolve_s8(const q7_t *input,
   ...
   *
   */
    int32_t xtensa_convolve_s8_get_buffer_size(const uint16_t input_ch,
                                            const uint16_t kernel_x,
                                            const uint16_t kernel_y);
   ...
   *
   */
    xtensa_status xtensa_convolve_HWC_q7_basic(const q7_t * Im_in,
   ...
   * @return     The function returns <code>XTENSA_MATHATH_SUCCESS</code>
   */
    xtensa_status xtensa_convolve_HWC_q7_basic_nonsquare(const q7_t * Im_in,
   ...
   *
   */
    xtensa_status xtensa_convolve_HWC_q15_basic(const q15_t * Im_in,
                                          const uint16_t dim_im_in,
                                          const uint16_t ch_im_in,
                                          const q15_t * wt,
                                          const uint16_t ch_im_out,
   ...
   * <code>XTENSA_MATHATH_SIZE_MISMATCH</code> or <coXTENSA_MATHA_MATH_SUCCESS</code> based on the outcome of size checking.
   *
   ...
   */
    xtensa_status xtensa_convolve_HWC_q7_fast(const q7_t * Im_in,
                                        const uint16_t dim_im_in,
                                        const uint16_t ch_im_in,
                                        const q7_t * wt,
                                        const uint16_t ch_im_out,
   ...
   */
    ...
    xtensa_status xtensa_convolve_HWC_q7_fast_nonsquare(const q7_t * Im_in,
                                                  const uint16_t dim_im_in_x,
                                                  const uint16_t dim_im_in_y,
                                                  const uint16_t ch_im_in,
                                                  const q7_t * wt,
   ...
   *   ch_im_out is multiple of 2
   */
    xtensa_status xtensa_convolve_1x1_HWC_q7_fast_nonsquare(const q7_t * Im_in,
                                                      const uint16_t dim_im_in_x,
                                                      const uint16_t dim_im_in_y,
                                                      const uint16_t ch_im_in,
                                                      const q7_t * wt,
   ...
   * @param[in]      output_y  output tensor height
   * @param[in]      buffer_a  pointer to buffer space used for input optimization(partial im2col) and is necessary
   *                           when XTENSA_MATHATH_LOOPUNROLL aXTENSA_MATHA_MATH_DSP is defined.
   *                           Required space: 2 * input_ch * sizeof(q15_t) bytes
   *                           Use xtensa_convolve_1x1_s8_fast_get_buffer_size() to get teh size
   * @return     The function returns either
   *                  <code>XTENSA_MATHATH_SIZE_MISMATCH</code> if argument constraints fail. or,
   *                  <code>XTENSA_MATHATH_SUCCESS</code> on successful completion.
   *
   * @details
   ...
   *
   */
    xtensa_status xtensa_convolve_1x1_s8_fast(const q7_t *input,
                                        const uint16_t input_x,
                                        const uint16_t input_y,
                                        const uint16_t input_ch,
                                        const q7_t *kernel,
   ...
   *
   */
    int32_t xtensa_convolve_1x1_s8_fast_get_buffer_size(const uint16_t input_ch);
   ...
   */
    ...
    xtensa_status xtensa_convolve_HWC_q7_RGB(const q7_t * Im_in,
                                       const uint16_t dim_im_in,
                                       const uint16_t ch_im_in,
                                       const q7_t * wt,
                                       const uint16_t ch_im_out,
   ...
   */
    ...
    xtensa_status xtensa_convolve_HWC_q15_fast(const q15_t * Im_in,
                                         const uint16_t dim_im_in,
                                         const uint16_t ch_im_in,
                                         const q15_t * wt,
                                         const uint16_t ch_im_out,
   ...
   */
    ...
    xtensa_status
    xtensa_convolve_HWC_q15_fast_nonsquare(const q15_t * Im_in,
                              const uint16_t dim_im_in_x,
                              const uint16_t dim_im_in_y,
                              const uint16_t ch_im_in,
                              const q15_t * wt,
   ...
   */
    ...
    xtensa_status xtensa_depthwise_separable_conv_HWC_q7(const q7_t * Im_in,
                                                   const uint16_t dim_im_in,
                                                   const uint16_t ch_im_in,
                                                   const q7_t * wt,
                                                   const uint16_t ch_im_out,
   ...
   *   ch_im_out is multiple of 2
   */
    xtensa_status xtensa_depthwise_separable_conv_HWC_q7_nonsquare(const q7_t * Im_in,
                                                             const uint16_t dim_im_in_x,
                                                             const uint16_t dim_im_in_y,
                                                             const uint16_t ch_im_in,
                                                             const q7_t * wt,
...
/**
   ...
   */
    ...
    xtensa_status xtensa_depthwise_conv_s8(const q7_t *input,
                                     const uint16_t input_x,
                                     const uint16_t input_y,
                                     const uint16_t input_ch,
                                     const q7_t *kernel,
...
/**
   ...
   * @param[in]       dilation_x   dilation along x. Not used. Dilation factor of 1 is used.
   * @param[in]       dilation_y   dilation along y. Not used. Dilation factor of 1 is used.
   * @param[in]       buffer_a     Buffer for partial im2col optimization. This is mandatory when XTENSA_MATHATH_LOOPUNROLL and
   *                               XTENSA_MATHATH_DSP are defined.
   *                               Required space: (2 * input_ch * kernel_x * kernel_y) * sizeof(q15_t) bytes
   *                               Use xtensa_depthwise_conv_s8_opt_get_buffer_size() to get the size.
   *
   * @return     The function returns one of the following
   *                <code>XTENSA_MATHATH_SIZE_MISMATCH</code> - Unsupported dimension of tensors
   *                <code>XTENSA_MATHATH_SUCCESS</code> - Successful operation
   *
   * @details
   *    1. Supported framework: TensorFlow Lite
   *    2. q7 is used as data type eventhough it is s8 data. It is done so to be consistent with existing APIs.
   ...
   *
   */
  xtensa_status xtensa_depthwise_conv_s8_opt(const q7_t *input,
                                       const uint16_t input_x,
                                       const uint16_t input_y,
                                       const uint16_t input_ch,
                                       const q7_t *kernel,
   ...
   *
   */
int32_t xtensa_depthwise_conv_s8_opt_get_buffer_size(const uint16_t input_ch,
                                                  const uint16_t kernel_x,
                                                  const uint16_t kernel_y);
 ...
 */
   ...
   */
    ...
    xtensa_status xtensa_fully_connected_q7(const q7_t * pV,
                                      const q7_t * pM,
   ...
   *                                               Use xtensa_fully_connected_s8_get_buffer_size() to get the size.
   * @return          The function returns         XTENSA_MATHATH_SUCCESS
   *
   * @details
   *
   * <b>Buffer size:</b>
   ...
   */
    ...
    xtensa_status
    xtensa_fully_connected_s8(const int8_t *pInput,
   ...
   *
   */
    int32_t xtensa_fully_connected_s8_get_buffer_size(const uint16_t col_dim);
   ...
   */
    ...
    xtensa_status xtensa_fully_connected_q7_opt(const q7_t * pV,
                                          const q7_t * pM,
                                          const uint16_t dim_vec,
                                          const uint16_t num_of_rows,
                                          const uint16_t bias_shift,
   ...
   */
    ...
    xtensa_status xtensa_fully_connected_q15(const q15_t * pV,
                                       const q15_t * pM,
                                       const uint16_t dim_vec,
                                       const uint16_t num_of_rows,
                                       const uint16_t bias_shift,
   ...
   */
    ...
    xtensa_status xtensa_fully_connected_q15_opt(const q15_t * pV,
                                           const q15_t * pM,
                                           const uint16_t dim_vec,
                                           const uint16_t num_of_rows,
                                           const uint16_t bias_shift,
   ...
   */
    ...
    xtensa_status xtensa_fully_connected_mat_q7_vec_q15(const q15_t * pV,
                                                  const q7_t * pM,
                                                  const uint16_t dim_vec,
                                                  const uint16_t num_of_rows,
                                                  const uint16_t bias_shift,
   ...
   */
    ...
    xtensa_status xtensa_fully_connected_mat_q7_vec_q15_opt(const q15_t * pV,
                                                      const q7_t * pM,
                                                      const uint16_t dim_vec,
                                                      const uint16_t num_of_rows,
                                                      const uint16_t bias_shift,
 ...
 *
 * The implementation is similar to CMSIS-DSP xtensa_mat_mult functions
 ...
 */
   ...
   */
    ...
    q7_t     *xtensa_nn_mat_mult_kernel_q7_q15(const q7_t * pA,
   ...
   *            Supported framework: TensorFlow Lite micro.
   */
    q7_t *xtensa_nn_mat_mult_kernel_s8_s16(const q7_t *input_a,
                                        const q15_t *input_b,
                                        const uint16_t output_ch,
                                        const int32_t *out_shift,
                                        const int32_t *out_mult,
   ...
   *
   * @details  For arguments, refer xtensa_nn_mat_mult_kernel_s8_s16. The re-ordering is a consequence
   ...
   *           Supported framework: TensorFlow Lite micro.
   */
    q7_t *xtensa_nn_mat_mult_kernel_s8_s16_reordered(const q7_t *input_a,
                                                  const q15_t *input_b,
                                                  const uint16_t output_ch,
                                                  const int32_t *out_shift,
                                                  const int32_t *out_mult,
   ...
   */
    q7_t     *xtensa_nn_mat_mult_kernel_q7_q15_reordered(const q7_t * pA,
                                                      const q15_t * pInBuffer,
                                                      const uint16_t ch_im_out,
                                                      const uint16_t numCol_A,
                                                      const uint16_t bias_shift,
...
/**
   ...
   * @return          The function returns    XTENSA_MATHATH_SUCCESS
   */
    xtensa_status xtensa_elementwise_add_s8(const int8_t *input_1_vect,
...
/**
   ...
   */
  xtensa_status xtensa_elementwise_mul_s8(const int8_t *input_1_vect,
                                    const int8_t *input_2_vect,
                                    const int32_t input_1_offset,
                                    const int32_t input_2_offset,
                                    int8_t *output,
 ...
 */
   ...
   */
    ...
    void      xtensa_relu_q7(q7_t *data, uint16_t size);
   ...
   */
    ...
    void      xtensa_relu6_s8(q7_t *data, uint16_t size);
   ...
   */
    ...
    void      xtensa_relu_q15(q15_t *data, uint16_t size);
   ...
   */
    ...
    void      xtensa_nn_activations_direct_q7(q7_t * data, uint16_t size, uint16_t int_width,
                                           xtensa_nn_activation_type type);
   ...
   */
    ...
    void      xtensa_nn_activations_direct_q15(q15_t * data, uint16_t size, uint16_t int_width,
                                            xtensa_nn_activation_type type);
 ...
 */
   ...
   */
    ...
    void      xtensa_maxpool_q7_HWC(q7_t * Im_in,
                                 const uint16_t dim_im_in,
                                 const uint16_t ch_im_in,
                                 const uint16_t dim_kernel,
                                 const uint16_t padding,
   ...
   */
    ...
    void      xtensa_avepool_q7_HWC(q7_t * Im_in,
                                 const uint16_t dim_im_in,
                                 const uint16_t ch_im_in,
                                 const uint16_t dim_kernel,
                                 const uint16_t padding,
   ...
   */
    ...
    void      xtensa_avepool_q7_HWC_nonsquare (
                                 const q7_t * Im_in,         
                                 const uint16_t dim_im_in_x,   
                                 const uint16_t dim_im_in_y,   
                                 const uint16_t ch_im_in,    
   ...
   *                                     XTENSA_MATHATH_LOOPUNROLL aXTENSA_MATHA_MATH_DSP are defined.
   *                                     Required space: (ch_src * dim_dst_width) * sizeof(q15_t) bytes
   *                                     Use xtensa_avgpool_s8_get_buffer_size() to get the size
   ...
   */
    ...
    void xtensa_avgpool_s8(const int dim_src_height,
   ...
   *
   */
    int32_t xtensa_avgpool_s8_get_buffer_size(const int dim_dst_width,
                                           const int ch_src);
   ...
   */
    ...
    void xtensa_max_pool_s8_opt(const uint16_t input_y,
                             const uint16_t input_x,
                             const uint16_t output_y,
                             const uint16_t output_x,
                             const uint16_t stride_y,
   ...
   *
   */
    void xtensa_max_pool_s8(const uint16_t input_y,
                         const uint16_t input_x,
                         const uint16_t output_y,
                         const uint16_t output_x,
                         const uint16_t stride_y,
...
void xtensa_softmax_q7(const q7_t * vec_in, const uint16_t dim_vec, q7_t * p_out);
...
void xtensa_softmax_with_batch_q7(const q7_t * vec_in, const uint16_t nb_batches,const uint16_t dim_vec, q7_t * p_out );
  /**
...
void xtensa_softmax_q15(const q15_t * vec_in, const uint16_t dim_vec, q15_t * p_out);
   ...
   *                <code>XTENSA_MATHATH_SIZE_MISMATCH</code> - Unsupported dimension of tensors
   *                <code>XTENSA_MATHATH_SUCCESS</code> - Successful operation
   *                <code>XTENSA_MATHATH_ARGUMENT_ERROR</code> - Implementation not available
   *
   ...
   *
   */
    xtensa_status xtensa_depthwise_conv_u8_basic_ver1(const uint8_t *input,
                                                const uint16_t input_x,
                                                const uint16_t input_y,
                                                const uint16_t input_ch,
