...
#ifndef __KWS_ESP32_H__
#define __KWS_ESP32_H__
...
//class KWS_ESP32 : public KWS_DNN {
class KWS_ESP32 : public KWS_DS_CNN {
public:
  KWS_ESP32(int recording_win, int sliding_window_len);
  ~KWS_ESP32();
  void start_kws();
