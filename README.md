# Keyword spotting for ESP32 

Forked from ARM's [Keyword spotting for Microcontrollers](https://github.com/ARM-software/ML-KWS-for-MCU) using
frankie "whyengineer" fork of ARM's [CMSIS for ESP32 ](https://github.com/whyengineer/esp32-lin)
